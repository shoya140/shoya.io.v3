...
Hatena.User = new Ten.Class({
    ...
    getProfileIcon: function(name) {
        ...
        img.src = 'http://www.hatena.ne.jp/users/' + pre + '/' + name + '/profile_m.gif';
...
Hatena.Star.Config = {
    ...
    isCommentButtonAvailable: false
}
...
Hatena.Star.AddButton = new Ten.Class({
    ...
    ImgSrc: 'http://hatenablog.com/images/theme/star/hatena-star-add-button.png',
